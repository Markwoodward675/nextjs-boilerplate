...
// Use this URL for all email verification redirects
...
/**
 * Ensure the given user has a verified email.
 * Can be used inside any mutating API helper.
 */
...
/**
 * Resend an email verification link to the current logged-in user.
 */
