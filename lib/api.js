 ...
 * Safe to call only when DB_ID is configured and collections exist.
 */
 ...
 *
 * params: { fullName, name, email, password }
 */
export async function registerUser(params) {
  ...
  // 2. Try to create a session (ignore "session already active" errors)
  try {
