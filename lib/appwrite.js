...
// Fallback DB ID if env is missing (you can change this)
export const DB_ID =
...
if (ENDPOINT && PROJECT_ID) {
  ...
  if (typeof window !== "undefined") {
    console.warn("[Day Trader] Missing Appwrite env vars:", {
      ENDPOINT,
      PROJECT_ID,
      DB_ID_ENV,
    });
...
// Collections (IDs must match your Appwrite collection IDs)
