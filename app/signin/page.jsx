    ...
    >
      <div className="w-full max-w-md bg-black/80 border border-yellow-500/80 rounded-2xl p-6 shadow-2xl backdrop-blur">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-gray-300 text-sm mt-1">Secure access to your dashboard.</p>
        </div>
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          ...
          <div className="flex items-center justify-between text-sm text-gray-300">
            <a className="text-yellow-400 hover:underline" href="/signup">Create account</a>
            <a className="text-yellow-400 hover:underline" href="/forgot-password">Forgot password</a>
          </div>
        </form>
      </div>
    </div>
