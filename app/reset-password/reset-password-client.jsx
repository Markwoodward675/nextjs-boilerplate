...
export default function ResetPasswordClient() {
  ...
  const can = useMemo(
    () => password.length >= 8 && userId && secret,
      ...
      <div className="min-h-[calc(100vh-64px)] bg-black/75 flex items-center justify-center">
        <div className="w-full max-w-md rounded-2xl border border-yellow-500/25 bg-black/70 shadow-2xl backdrop-blur p-6">
          <div className="flex items-center justify-center gap-3">
            <div className="h-10 w-10 rounded-xl border border-yellow-500/40 bg-black/60 p-1 flex items-center justify-center overflow-hidden">
          ...
          {!userId || !secret ? (
            <div className="mt-5 rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-[12px] text-red-200">
            ...
            <>
              ...
              {msg ? (
                <div className="mt-5 rounded-xl border border-emerald-500/25 bg-emerald-500/10 px-4 py-3 text-[12px] text-emerald-200">
                  {msg}
                </div>
              ) : null}
